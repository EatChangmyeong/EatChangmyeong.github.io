...
* 카메라의 원근감 `persp`
	...
	* [돌리 줌](https://en.wikipedia.org/wiki/Dolly_zoom)과 같은 원리로 구현되어 있습니다. 더 자세하게는 카메라와 피사체의 거리가 $$\frac{1}{\mathrm{persp}}$$이 되도록 설정되어 있습니다.[^fn-dolly-zoom-coefficient]
