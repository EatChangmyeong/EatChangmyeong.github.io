...
$$B^A$$는 다름이 아니라 $$A$$를 받아서 $$B$$를 내놓는 **함수 타입**인 것을 알 수 있습니다. 마침 집합 $$A$$에서 $$B$$로 가는 함수도 $$|B|^{\lvert A \rvert}$$개 있네요. 아쉽지만 거듭제곱 타입은 Haskell 등 함수에 부작용이 없는 순수 함수형 언어에서만 성립하는 개념이라 자주 언급되지는 않습니다.
